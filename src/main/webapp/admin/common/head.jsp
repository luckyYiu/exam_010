...
<body>
	<div style="width: 100%; height: 98px; background-color: #438EB9;">
		...
		<div id="loginTeacher" style="float:right; width: 190px; height:100%;line-height: 80px;">
			<c:if test="<%=SecurityUtils.getSubject().getPrincipal() != null%>">
				<a target="right" class="btn btn-default" href="${path}teacher/self.action?teacherId=${sessionScope.loginTeacher.teacherId }" style="margin-left: 9px;">
			...
			<a class="btn btn-default" href="${path}teacher/logout.action" target="_parent">退出登录</a>
		</div>
	</div>
