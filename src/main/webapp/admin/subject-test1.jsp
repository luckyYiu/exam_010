...
<body>
	...
	<form action="subject" id="radio-form">
		...
		<input id="subjectId" name="subjectId" type="hidden" value="${subject.subjectId }" readonly="readonly" unselectable='on' onfocus='this.blur()' />
						...
						<div class="col-md-12 column" style="margin-top:5px;">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-5" style="padding-left: 43px;width:21.5%;margin-left: 0px;">
									<input id="sub" onclick="updateSubject()" value="提交"
