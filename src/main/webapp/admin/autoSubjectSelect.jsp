...
<%@page import="com.qhit.service.impl.CourseInfoServiceImpl"%>
<%@page import="com.qhit.pojo.CourseInfo"%>
<%@page import="com.qhit.pojo.GradeInfo"%>
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form class="form-horizontal" role="form">
					<input type="hidden" value="${param.examPaperId }" name="examPaperId" id="examPaperId" />
					<div class="form-group">
						<label for="subjectSum" class="col-sm-2 control-label">试题数量</label>
						<div class="col-sm-10">
							<input class="form-control" name="subjectNum" id="subjectNum" type="text" placeholder="自动生成试题数量" />
						</div>
					</div>
					<div class="form-group">
