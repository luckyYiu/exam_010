				...
				<div class="col-md-12 column">
					<form class="form-horizonta form-signinl" onsubmit="return receptionLoginValidate()" role="form" action="../studentLogin" method="post" id="receptionLogin" name="receptionLogin">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" name="studentAccount" id="username" type="text" placeholder="考试登录账号" />
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								 <input onclick="studentLogin()" type="button" class="btn btn-default btn-lg btn-primary btn-block" id="sutdentSignIn" value="登 录"></input>
							</div>
						</div>
					</form>
				</div>
