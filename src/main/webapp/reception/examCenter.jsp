...
<%@page import="com.qhit.service.impl.ExamHistoryInfoServiceImpl"%>
<%@page import="com.qhit.pojo.ExamPlanInfo"%>
								...
								<div class="col-md-4">
									<div class="thumbnail">
										...
										<div class="caption">
											...
											<p>
												<a class="btn btn-default btn-lg btn-block beginExam" id="${ep.examPaper.examPaperId }" href="${path}examPaper/joinToExaming.action?classId=${ep.clazz.classId }&examPaperId=${ep.examPaper.examPaperId }&studentId=${sessionScope.loginStudent.studentId }&examTime=${ep.examPaper.examPaperTime }&beginTime=${ep.beginTime }">进入考试</a>
											</p>
										</div>
									</div>
								</div>
